...
|---------|---------|----------|
| [infinite.md](./commands/infinite.md) | Parallel generation with sub-agents | Generating many variations of a spec |
| [parallel_volley.md](./commands/parallel_volley.md) | 3-phase volley across parallel batches | Bulk implementation with quality gates |
| [parallel_volley_funnel.md](./commands/parallel_volley_funnel.md) | Evolutionary many-to-one refinement | Design swarms with culling |
...
| [docs_as_coding_verification.md](./commands/docs_as_coding_verification.md) | Documentation-driven verification | Quality auditing |
...
| [CLAUDE_CODE_DOCUMENTATION_SPEC.md](./specs/CLAUDE_CODE_DOCUMENTATION_SPEC.md) | Documentation standards | Docs |
...
See [../../templates/spec_template.md](../../templates/spec_template.md) for a template.
