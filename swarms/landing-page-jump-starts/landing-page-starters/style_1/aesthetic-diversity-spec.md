...
Before generating, engage in **Deep Reflection**:

1.  **Define the Vibe**: "I am designing a [Lineage] interface that feels like [Metaphor]."
    *   *Example:* "I am designing a Cyber-Noir interface that feels like a hacker's deck in 2077."
2.  **Select the Palette**: Pick 3-4 specific hex codes that define the world.
3.  **Interaction Novelty**: What is the *one* cool interaction? (e.g., "The menu is a rotary phone dial" or "Hovering reveals x-ray vision").
4.  **Avoidance**: What "Standard Web Design" tropes will I explicitly avoid? (e.g., "No Hamburger menus", "No Hero Image").

**GOAL:** The user should open the file and say "Wow, I haven't seen a website work like this before."
